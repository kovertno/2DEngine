-- Load a different tilemap depending on the current system time
local current_system_hour = os.date("*t").hour

local map_texture_asset_id

-- Using day or night texture based on time (9:00 - 18:00 day, else night)
    ...
    entities = {
        [0] =
        {
            ...
            components = {
                ...
                keyboard_controller = {
                    up_velocity = { x = 0, y = -70 },
                    right_velocity = { x = 70, y = 0 },
                    down_velocity = { x = 0, y = 70 },
                    left_velocity = { x = -70, y = 0 }
                },
                camera_follow = {
                    follow = true
                }
