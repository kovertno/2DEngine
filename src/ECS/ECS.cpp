...
void System::RemoveEntityFromSystem(Entity entity){
    //i think there could be just a std::remove but for the sake of learning lambdas,
    //and getting a better understanding of operator overloading, i went with std::remove_if
...
void Registry::Update() {
    ...
    for (auto entity : entitiesToBeKilled) {
        ...
        // Make entity id available to re reused
